...
| (RBAC)Admin dashboard manage users                                         | Admin dashboard allowed access to user management without fine-grained role checks; any authenticated admin could perform all actions. | Role-based access control (RBAC) applied. Only users with `super-admin` role can delete users or change roles; other admins have limited permissions (view/edit). Policies define access per action. <br> <img width="818" height="182" alt="image" src="https://github.com/user-attachments/assets/b0ac5ee0-c8da-4fde-b3f3-eeeee625e7a7" /> <br> <img width="623" height="408" alt="image" src="https://github.com/user-attachments/assets/7cd74fa0-0c58-413b-b07f-4a82a5dedad4" /> <br> <img width="944" height="715" alt="image" src="https://github.com/user-attachments/assets/fa8f4bef-7e92-49a3-ad56-ac872e09c810" /> <br> <img width="947" height="697" alt="image" src="https://github.com/user-attachments/assets/7616f6ff-dbe8-4aa3-a4fd-016456cd7c7d" /> | <img width="1919" height="914" alt="image" src="https://github.com/user-attachments/assets/82c60166-814e-490e-8db9-97ac0d6ec5a2" />| 
| Insecure Direct Object References (IDOR) | URLs used numeric IDs (`/user/5/edit`) without validation. Any logged-in user could manipulate IDs to access other users’ data. | Policies and route model binding enforce that users can only access resources they own or are permitted to. For example, `/user/{id}/edit` checks authorization before serving the page. <br> <img width="964" height="705" alt="image" src="https://github.com/user-attachments/assets/92b6a70b-31cb-4158-b4b0-f3337b4795dc" /> <br> <img width="914" height="257" alt="image" src="https://github.com/user-attachments/assets/bcaf76bf-7237-463d-9ad1-c324a6499ad5" /> | |
...
|  Table Column Output Escaping  | **Before:**<br>- Table columns show raw data (`Tables\Columns\TextColumn::make('name')->label('Customer Name')`) implemented | **After:**<br>- **Auto-escaping for display and tooltips** applied <img width="860" height="325" alt="Screenshot 2025-12-28 085814" src="https://github.com/user-attachments/assets/ff793d82-34a6-4d08-85a7-c3fa72ecf2e1" /> | <img width="1238" height="103" alt="image" src="https://github.com/user-attachments/assets/fe104378-196f-4850-93cc-b1118eeb2634" />
|  Notification Message Escaping  | **Before:**<br>- User data in notifications causes XSS (`Notification::make()->body("Issues found: $userInput")`) implemented | **After:**<br>- **All notification text escaped** applied <img width="636" height="224" alt="Screenshot 2025-12-28 085911" src="https://github.com/user-attachments/assets/2a1ab048-0e60-4d45-9d8e-6d482cd3f657" /> | <img width="1009" height="165" alt="image" src="https://github.com/user-attachments/assets/27286699-5826-485e-9b97-27f53a2760f7" /> <img width="424" height="162" alt="image" src="https://github.com/user-attachments/assets/88ee4200-976f-457d-a694-665511aa2493" />#<br> Validate using trigger notification -> Nothing appeared -> protected
 |   Filename Sanitization for XSS  | **Before:**<br>- Raw filenames used for downloads (`$filename = "invoice_$customerName.pdf";`) implemented | **After:**<br>- **Multiple sanitization layers** applied <img width="895" height="262" alt="Screenshot 2025-12-28 090055" src="https://github.com/user-attachments/assets/0d1a96c8-b430-4e60-9622-8c996be91437" /> | <img width="950" height="781" alt="image" src="https://github.com/user-attachments/assets/0077156c-e47f-4659-88a2-f155e4bef93c" />
|   Token-Based URL Generation  | **Before:**<br>- URLs without token verification (`Tables\Actions\Action::make('Print PDF')->url(fn ($record) => route('print.invoice', ['id' => $record->id]))`) implemented | **After:**<br>- **Unique session-based tokens** applied <img width="605" height="225" alt="Screenshot 2025-12-28 090215" src="https://github.com/user-attachments/assets/97db5aac-ef9b-4ba5-adfb-f0245332eac4" /> | <img width="817" height="610" alt="image" src="https://github.com/user-attachments/assets/369355a5-ac23-43f7-a98c-9450f5f40458" /> <img width="878" height="221" alt="image" src="https://github.com/user-attachments/assets/95ea5117-b0c9-4a80-9e28-61f71081e300" />
