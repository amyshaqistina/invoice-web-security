...
| **Security & Functionality Aspect**                                  | **Before Enhancement**                                                                                                                 | **After Enhancement**                                                                                                                                                                                | **Visual Representation**                                                 |
| -------------------------------------------------------------------- | -------------------------------------------------------------------------------------------------------------------------------------- | ---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ------------------------------------------------------------------------- |
| Re-check authorization before sensitive actions (TOCTTOU prevention) | Sensitive actions relied only on initial page load permissions; no runtime re-checks.                                                  | Implemented middleware and policy checks on every request for sensitive actions. Server-side authorization enforced for actions like user deletion or role changes. TOCTTOU risk mitigated.          | |
