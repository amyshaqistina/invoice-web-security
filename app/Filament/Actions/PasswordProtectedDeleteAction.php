...
class PasswordProtectedDeleteAction extends DeleteAction
{
    ...
    protected function setUp(): void
    {
        ...
        $this->modalHeading('Confirm Deletion');

        $this->modalDescription('This is a sensitive action. Please enter your password to confirm.');
        ...
        $this->form(function () {
            ...
            return [
                TextInput::make('password_confirmation')
                    ...
                    ->helperText('Enter your current password to proceed with deletion.')
